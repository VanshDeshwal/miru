...
query($page: Int, $perPage: Int, $sort: [MediaSort], $search: String, $status: [MediaStatus]){
  Page(page: $page, perPage: $perPage){
    ...
    media(type: MANGA, search: $search, sort: $sort, status_in: $status, isAdult: false, format_not: MUSIC){
      ${queryObjects}
    }
  }
}`
...
query($id: [Int], $page: Int, $perPage: Int, $status: [MediaStatus], $onList: Boolean, $sort: [MediaSort], $search: String, $season: MediaSeason, $year: Int, $genre: String, $format: MediaFormat){ 
  Page(page: $page, perPage: $perPage){
    ...
    media(id_in: $id, type: MANGA, status_in: $status, onList: $onList, search: $search, sort: $sort, season: $season, seasonYear: $year, genre: $genre, format: $format){
      ${queryObjects}
    }
  }
}`
...
query($page: Int, $perPage: Int, $id: Int, $status_in: [MediaListStatus]){
  Page(page: $page, perPage: $perPage){
    ...
    mediaList(userId: $id, type: MANGA, status_in: $status_in, sort: UPDATED_TIME_DESC){
      media{
        ${queryObjects}
      }
    }
      ...
      query = /* js */` 
query($id: Int){
  MediaListCollection(userId: $id, status_in: [REPEATING, COMPLETED], type: MANGA, forceSingleCompletedList: true){
    lists{
      entries{
        media{
          relations{
...
query($page: Int, $perPage: Int, $sort: [MediaSort], $search: String, $status: MediaStatus, $season: MediaSeason, $year: Int, $genre: String, $format: MediaFormat){
  Page(page: $page, perPage: $perPage){
    ...
    media(type: MANGA, search: $search, sort: $sort, status: $status, season: $season, seasonYear: $year, genre: $genre, format: $format, format_not: MUSIC){
      ${queryObjects}
    }
  }
}`
